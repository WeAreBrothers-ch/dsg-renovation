...
| `equipe.py`, `equipe_immobile.json` | ouvriers de l'accueil : dessin des silhouettes, sections où ils vivent, pose immobile |
...
| `equipe.js` | ouvriers de l'accueil : quatre silhouettes, une par section, qui marchent et travaillent au rythme du défilement |
